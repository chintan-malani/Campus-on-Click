...
$qry="SELECT * FROM student where email='".$_POST['email']."' and isactive=1 and sec_que_ans='".$_POST['que']."' and answer='".$_POST['answer']."'";
...
{
    echo "<script>alert('Wrong Question or Answer');</script>";;
...
<body>
   ...
   <div class="container-fluid page-title ">
        <h2 class="text-info text-center" style="font-weight: bold;">Reset Password</h2>
    ...
    <div class="row ">
        ...
        <div class="col-xs-10 col-sm-8 col-md-6 col-lg-6">
            <div class="contact-page-content" style="border-radius: 10px;">
                ...
                <form action="resetpasspro.php" method="post" id="myform" data-parsley-validate>
                    <div class="form-group">
                     <label for="email"><b>New Password</b></label>
                    <input type="password" name="pass" placeholder="New Password" class="form-control" required=""><br>
                    <label for="email"><b>Confirm Password</b></label>
                    <input type="password" name="cpass" placeholder="Confirm Password" class="form-control" required=""><br>
