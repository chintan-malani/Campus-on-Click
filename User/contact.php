...
<body>
    ...
    <div class="container page-title" style="background-color:#747577;">
       ...
       <h2 class="text-center" style="font-weight: bold;color:white;">Contact Us</h2>
    ...
    <div class="row ">
        ...
        <div class="col-xs-10 col-sm-8 col-md-6 col-lg-6">
            ...
            <div class="contact-page-content" style="border-radius: 10px;border:2px solid #004884;">
                ...
                <form action="contactpro.php" method="post" id="myform" data-parsley-validate>
                    <div class="form-group">
                    <label for=""><b>Name</b></label>
                    <input name="name" rows="5" class="form-control" placeholder="Name">
                    <br>
                    <label for=""><b>Email</b></label>
                    <input name="email" rows="5" class="form-control" placeholder="Email" type="email">
                    <br>
                    <label for=""><b>Contact</b></label>
                    <input name="contact" rows="5" class="form-control" placeholder="Contact">
                    <br>
