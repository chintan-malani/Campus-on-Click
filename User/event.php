        ...
        <div class="page-title clearfix">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h6><span class="page-active">Event</span></h6>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="box-content-inner clearfix">
                            <div class="list-event-thumb">
                               ...
                               <p class="font-weight-bold">Event Name</p>
                                ...
                                <p class="font-weight-bold">Place of Event</p>
                                 
                                 <button type="submit" class="btn btn-success ">View</button>
                            </div>
                            <div class="list-event-header">
                                 <h3 class="font-weight-bold">Event</h3>
                                <span class="event-date small-text"><i class="fa fa-calendar-o"></i>January 08, 2014<!-- date of upload --></span>
