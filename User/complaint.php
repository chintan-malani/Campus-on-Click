...
<body>
        ...
        <div class="page-title clearfix">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h6><span class="page-active">Complaint</span></h6>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container page-title" style="background-color:#747577;">
       ...
       <h2 class="text-center" style="font-weight: bold;color:white;">Drop Complaint</h2>
    ...
    <div class="row ">
        ...
        <div class="col-xs-10 col-sm-8 col-md-6 col-lg-6">
            ...
            <div class="contact-page-content" style="border-radius: 10px;border:2px solid #004884;">
                ...
                <form action="Complaintpro.php" method="post" id="myform" data-parsley-validate>
                    ...
                    <br>
                    <label for=""><b>Complaint</b></label>
                    <textarea name="complain" rows="5" class="form-control" placeholder="Complaint"></textarea>
                    <br>
                </div>
