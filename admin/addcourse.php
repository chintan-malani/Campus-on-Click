   ...
   <div class="content-section">
    ...
    // FOREIGN KEY
                                           ...
                                           while($rowd=mysqli_fetch_assoc($rs))
                                            {
                                            ?>
                                              <option value="<?php echo $rowd['department_id'];?>"><?php echo $rowd['name'];?></option>
                                          <?php } ?>
                                      </select>
                                  </td>
                              </tr>
                                <tr>
                                    ...
                                    <td class="col-md-8"><input type="text" placeholder="Course" class="form-control" name="course"></td>
                                </tr>
