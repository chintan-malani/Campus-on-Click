             ...
             <?php 
                ...
                if (mysqli_num_rows($rs)>0) 
                {
                    ...
                    while ($row = mysqli_fetch_assoc($rs)) 
                    {
                        ...
                        <td><a href="area_edit.php?id=<?php echo$row['area_id']; ?>">Edit</a></td>
                        <td><a href="area_delete.php?id=<?php echo$row['area_id']; ?>">Delete</a>
                            <?php 
                              if ($row['isactive']==1) {
                             ?>
                        <td><a href="area_status.php?id=<?php echo$row['area_id']; ?>">block</a></td>
                             <?php 
                                }
                                else{
                              ?>
                       <td><a href="area_status.php?id=<?php echo$row['area_id']; ?>">Active</a></td>
                              <?php 
                                  }
                               ?>
