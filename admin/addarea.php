...
<div class="wrapper">
    ...
    $qry1 = "select city_id,city_name from city WHERE isactive=1";
    ...
    ?>
                        ...
                        <div class="table-box">
                                        <table class="table">
                                            <tbody>
                                                 <tr>
                                                     <td class="col-md-4">Select State:</td>
                                                     <td>
                                                 ...
                                                 <tr>
                                                     <td class="col-md-4">Select city:</td>
                                                     <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col-md-8"><input type="text" placeholder="area name" class="form-control"
                                                        name="areaname"></td>
                                                </tr>
                                                    <td class="col-md-4">
