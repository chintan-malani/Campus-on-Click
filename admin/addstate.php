            ...
            <div class="content-section">
                <div class="container-liquid">
                    <div class="row">
                        ...
                        <div class="table-box">
                                        <table class="table" >
                                            <form action="stateprocess.php" method="POST">
                                            <tbody>
                                                <tr>
                                                    <td class="col-md-4">Add State name:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="state name" name="statename" class="form-control"></td>
                                                </tr>
                                                    <td class="col-md-4">
                                                        <button class="btn btn-success" name="btn_sb"> Submit</button></td>
                                                    <td class="col-md-8">
