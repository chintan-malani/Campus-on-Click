...
<!-- Mirrored from extracoding.com/demo/html/adminise/login2.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Oct 2019 07:50:24 GMT -->
...
<div class="loginwrapper whiter">
	...
	<div class="loginone">
    	<header>
        	<a href="dashboard1.php"><img src="assets/images/xlogodark.png.pagespeed.ic.7_n9yLJA3c.png" alt=""/></a>
        ...
        <form>
			...
			<script>$(document).ready(function(){$('.minimalcheckradios').iCheck({checkboxClass:'icheckbox_minimal',radioClass:'iradio_minimal',increaseArea:'20%'});});</script>
