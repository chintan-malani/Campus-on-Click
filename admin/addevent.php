                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="col-md-8"><input type="text" placeholder="event name" class="form-control" name="event"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Add description</td>
                                                    <td class="col-md-8"><input type="text" placeholder="description" class="form-control" name="description"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">venue:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="venue" class="form-control" name="venue"></td>
                                                </tr>
                                                    <td class="col-md-4">
