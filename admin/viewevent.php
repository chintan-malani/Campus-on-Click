    ...
    <div class="structure-row">
        ...
        <div class="right-sec">
            ...
            <div class="content-section">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">View event</h2>
                                </header>
                                <div class="contents">
                ...
                $qry = "SELECT * FROM event WHERE isactive !=2 order by event_id desc";
                // echo $qry;
                ...
                if (mysqli_num_rows($rs)>0) 
                {
                    ...
                    while ($row = mysqli_fetch_assoc($rs)) 
                    {
                        ...
                        <td><?php echo $row['place_of_event']; ?></td>
                        <td><?php echo $row['isactive']; ?></td>
                        <td><?php echo $row['doi']; ?></td>
                        <td><?php echo $row['dou']; ?></td>
                        <td><a href="editevent.php?id=<?php echo $row['event_id'];?>">Edit</a></td>
                        <td><a href="deleteevent.php?id=<?php echo $row['event_id'];?>">Delete</a></td>
                        </tr>
