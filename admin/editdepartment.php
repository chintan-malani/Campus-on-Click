...
$qry="SELECT * FROM department where department_id='".$_GET['id']."'";
            ...
            <div class="content-section">
                <div class="container-liquid">
                    <div class="row">
                        ...
                        <div class="table-box">
                                        <table class="table">
                                            <form action="updatedepartmentprocess.php" method="POST">
                                            <tbody>
                                                 <tr>
                                                    <td class="col-md-4">Add Department:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="department" class="form-control" name="department" value="<?php echo $row['name'];?>">
                                                    	<input type="hidden" name="d_id" value="<?php echo $_GET['id'];?>">
                                                    </td>
                                                </tr>
                                                    <td class="col-md-4">
