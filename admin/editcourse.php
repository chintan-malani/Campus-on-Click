...
$qrys="SELECT * FROM course where course_id='".$_GET['id']."'";
   ...
   <div class="content-section">
    <div class="container-liquid">
        <div class="row">
            ...
            <div class="col-xs-2">
                <div class="table-box">
                    <table class="table">
                        <form action="updatecoursepro.php" method="POST">
                            <tbody>
                                <tr>
    ...
    // FOREIGN KEY
                                           ...
                                           while($rowd=mysqli_fetch_assoc($rs))
                                            {
                                            ?>
                                              <option value="<?php echo $rowd['department_id'];?>" <?php if($rows['department_id'] == $rowd['department_id']){ echo 'selected';} ?>><?php echo $rowd['name'];?></option>
                                          <?php } ?>
                                      </select>
                                  </td>
                              </tr>
                                <tr>
                                    <td class="col-md-4">Add Course:</td>
                                    <td class="col-md-8"><input type="text" placeholder="Course" class="form-control" name="course" value="<?php echo $rows['course_name'];?>">
