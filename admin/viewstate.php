            ...
            <div class="content-section">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">View state</h2>
                                </header>
                                <div class="contents">
                ...
                if (mysqli_num_rows($rs)>0) 
                {
                    ...
                    while ($row = mysqli_fetch_assoc($rs)) 
                    {
                        ...
                        <td><a href="state_delete.php?id=<?php echo$row['state_id']; ?>">Delete</a>
                            <?php 
                              if ($row['isactive']==1) {
                             ?>
                        <td><a href="state_status.php?id=<?php echo$row['state_id']; ?>">block</a></td>
                             <?php 
                                }
                                else{
                              ?>
                       <td><a href="state_status.php?id=<?php echo$row['state_id']; ?>">Active</a></td>
                              <?php 
                                  }
                               ?>
