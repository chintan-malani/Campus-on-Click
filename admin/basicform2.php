                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Author Management</h2>
                                </header>
                                <div class="contents">
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="col-md-8"><input type="text" placeholder="Author Name" class="form-control"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Book Name:</td>
                                                    <td class="col-md-8"><input type="text"  placeholder="Book Name:" class="form-control"></td>
                                                </tr>
                                                    <td class="col-md-4">
