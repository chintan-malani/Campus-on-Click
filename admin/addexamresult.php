        ...
        <div class="right-sec">
            ...
            <div class="content-section">
                <div class="container-liquid">
                    <div class="row">
                        <header>
                                    <h2 class="heading">Add Results</h2>
                                </header>
                        <div class="table-box">
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td class="col-md-4">Add result:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="result" class="form-control"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Add markseet</td>
                                                    <td class="col-md-8"><input type="text" placeholder="markseet" class="form-control"></td>
                                                </tr>
                                                    <td class="col-md-4">
