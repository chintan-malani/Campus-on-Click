                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">View Subject</h2>
                                </header>
                                <div class="contents">
                                    ...
                                    <section>
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                $qry="SELECT * FROM subject_detail where isactive=1";
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="editsub.php?id=<?php echo $row['subject_id'];?>">Edit</a></td>
                                                    <td><a href="deletesub.php?id=<?php echo $row['subject_id'];?>">Delete</a></td>
                                                </tr>
                                               <?php
                                                }
                                               ?>
