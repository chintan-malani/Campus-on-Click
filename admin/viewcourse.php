    ...
    <div class="structure-row">
        ...
        <div class="right-sec">
            ...
            <div class="content-section">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">View course</h2>
                                </header>
                                <div class="contents">
                ...
                $qry = "SELECT ci.course_id,ci.isactive ,ci.course_name,ci.department_id,ci.doi,ci.dou,st.name,st.department_id FROM course as ci LEFT JOIN department as st ON ci.department_id=st.department_id WHERE ci.isactive !=2";
                // echo $qry;
                ...
                if (mysqli_num_rows($rs)>0) 
                {
                    ...
                    while ($row = mysqli_fetch_assoc($rs)) 
                    {
                        ...
                        <td><a href="editcourse.php?id=<?php echo $row['course_id'];?>">Edit</a></td>
