        ...
        <div class="right-sec">
            ...
            <div class="content-section">
                <div class="container-liquid">
                    <div class="row">
                        <header>
                                    <h2 class="heading">Edit city</h2>
                                </header>
                        <div class="table-box">
                                        <table class="table" >
                                            <form action="city_editPro.php" method="POST">
                                            	<input type="hidden" name="sid" value="<?php echo$row['city_id']; ?>"> 
                                            <tbody>
                                                <tr>
                                                    <td class="col-md-4">Add city name:</td>
                                                    <td class="col-md-8"><input type="text"  name="sname" value="<?php echo$row['city_name']; ?>" class="form-control"></td>
                                                </tr>
                                                    <td class="col-md-4">
