                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="col-md-8"><input type="text" placeholder="Categoryname" class="form-control"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Book Catagory Name:</td>
                                                    <td class="col-md-8"><input type="text"  placeholder="book Category Name" class="form-control"></td>
                                                </tr>
                                                 <tr>
                                                    <td class="col-md-4">Book Author Name:</td>
                                                    <td class="col-md-8"><input type="text"  placeholder="book Athor Name" class="form-control"></td>
                                                </tr>
