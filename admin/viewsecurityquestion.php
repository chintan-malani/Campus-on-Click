    ...
    <div class="structure-row">
        ...
        <div class="right-sec">
            ...
            <div class="content-section">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">View security question</h2>
                                </header>
                                <div class="contents">
                ...
                $qry = "SELECT * FROM security_question WHERE isactive !=2";
                // echo $qry;
                $rs = mysqli_query($conn,$qry);
                    while ($row = mysqli_fetch_assoc($rs)) 
                    {
                        ...
                        <td><a href="securityquestion_edit.php?id=<?php echo $row['sec_que_id']; ?>">Edit</a></td>
                        <td><a href="securityquestion_delete.php?id=<?php echo $row['sec_que_id']; ?>">Delete</a>
