    ...
    <div class="structure-row">
        ...
        <div class="right-sec">
            ...
            <div class="content-section">
                ...
                $qry = "SELECT ci.city_id,ci.isactive ,ci.city_name,ci.state_id,ci.doi,ci.dou,st.state_name,st.state_id FROM city as ci LEFT JOIN state as st ON ci.state_id=st.state_id WHERE ci.isactive !=2";
                //echo $qry;
                ...
                if (mysqli_num_rows($rs)>0) 
                {
                    ...
                    while ($row = mysqli_fetch_assoc($rs)) 
                    {
                        ...
                        <td><a href="city_delete.php?id=<?php echo$row['city_id']; ?>">Delete</a>
                            <?php 
                              if ($row['isactive']==1) {
                             ?>
                        <td><a href="city_status.php?id=<?php echo$row['city_id']; ?>">block</a></td>
                             <?php 
                                }
                                else{
                              ?>
                       <td><a href="city_status.php?id=<?php echo$row['city_id']; ?>">Active</a></td>
                              <?php 
                                  }
                               ?>
