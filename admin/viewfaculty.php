                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">Manage faculty</h2>
                                </header>
                                <div class="contents">
                                    ...
                                    <section>
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php
                                                $qry="SELECT * FROM faculty where isactive=1 order by faculty_id desc";
                                                $rs=mysqli_query($conn,$qry);
                                                while($row=mysqli_fetch_assoc($rs))
                                                {
                                                    $qrye="SELECT * FROM department where department_id='".$row['department_id']."'";
                                                    $rse=mysqli_query($conn,$qrye);
                                                    $rowe=mysqli_fetch_assoc($rse);

                                                    $qryc="SELECT * FROM course where course_id='".$row['course_id']."'";
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="../faculty/<?php echo $row['profile_pic'];?>" height="100" width="100"></td>
                                                    <td><?php echo $row['doi'];?></td>
                                                    
                                                    <td><a href="deletefaculty.php?id=<?php echo $row['faculty_id'];?>">Delete</a></td>
                                                </tr>
                                             <?php
                                                }  
                                             ?>
