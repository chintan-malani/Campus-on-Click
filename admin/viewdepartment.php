    ...
    <div class="structure-row">
        ...
        <div class="right-sec">
            ...
            <div class="content-section">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="sec-box">
                                ...
                                <header>
                                    <h2 class="heading">View notice</h2>
                                </header>
                                <div class="contents">
                ...
                $qry = "SELECT * FROM department WHERE isactive !=2";
                // echo $qry;   
                ...
                if (mysqli_num_rows($rs)>0) 
                {
                    ...
                    while ($row = mysqli_fetch_assoc($rs)) 
                    {
                        ...
                        <td><a href="editdepartment.php?id=<?php echo $row['department_id'];?>">Edit</a></td>
                        <td><a href="deletedepartment.php?id=<?php echo $row['department_id'];?>">Delete</a></td>
                        </tr>
