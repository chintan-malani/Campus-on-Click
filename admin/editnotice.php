...
$qry = "SELECT * FROM notice WHERE isactive=1 and notice_id='".$_GET['id']."'";
                // echo $qry;
        ...
        <div class="right-sec">
            ...
            <div class="content-section">
                <div class="container-liquid">
                    <div class="row">
                        <header>
                                    <h2 class="heading">Add Notice</h2>
                                </header>
                        <div class="table-box">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="col-md-4">Add title:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="title" class="form-control" name="notice" value="<?php echo $row['title'];?>"></td>
                                                </tr>
                                                                                        
                                                    <td class="col-md-4">Add description:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="description" class="form-control" name="description" value="<?php echo $row['description'];?>">
