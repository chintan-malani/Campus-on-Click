                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="col-md-8"><input type="text" placeholder="Firstname" class="form-control"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Last Name:</td>
                                                    <td class="col-md-8"><input type="text" disabled="" placeholder="Last Name:" class="form-control"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Email:</td>
                                                    <td class="col-md-8"><input type="text" disabled="" placeholder="Email:" class="form-control"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Password:</td>
                                                    <td class="col-md-8"><input type="password" placeholder="Password" class="form-control"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Comfirm Password:</td>
                                                    <td class="col-md-8"><input type="Comfirm password" placeholder="Password" class="form-control"></td>
                                                </tr>
                                                    <td class="col-md-4">
...
<!-- Mirrored from extracoding.com/demo/html/adminise/basicform.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Oct 2019 07:50:20 GMT -->
</html>
