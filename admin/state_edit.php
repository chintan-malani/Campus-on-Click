        ...
        <aside class="sidebar">
        	<div class="sidebar-in">
                ...
                <header>
                    <!-- Logo Start -->
                    <div class="logo">
                        <a href="dashboard1.php"><img src="assets/images/adminlogo1.png" alt="Campus on click"/></a>
                    </div>
                    <!-- Logo End -->
                    <!-- Toggle Button Start -->
            ...
            <div class="content-section">
                <div class="container-liquid">
                    <div class="row">
                        ...
                        <div class="table-box">
                                        <table class="table" >
                                            <form action="state_editPro.php" method="POST">
                                            	<input type="hidden" name="sid" value="<?php echo$row['state_id']; ?>"> 
                                            <tbody>
                                                <tr>
                                                    <td class="col-md-4">Add State name:</td>
                                                    <td class="col-md-8"><input type="text"  name="sname" value="<?php echo$row['state_name']; ?>" class="form-control"></td>
                                                </tr>
                                                    <td class="col-md-4">
