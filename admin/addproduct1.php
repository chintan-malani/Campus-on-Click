                                        ...
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col-md-8"><input type="text" placeholder="Product Name" class="form-control"></td>
                                                </tr>

                                                
                                                <tr>
                                                    <td class="col-md-4">Sub Catagory Name:</td>
                                                    <td class="col-md-8"><input type="text" disabled="" placeholder="SubCategoryName:" class="form-control"></td>
                                                </tr>
                                                    <td class="col-md-4">
