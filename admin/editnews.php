...
$qry = "SELECT * FROM News WHERE isactive=1 and news_id='".$_GET['id']."'";
                // echo $qry;
                       ...
                       <form action="updatenews.php" method="POST">
                        <tbody>
                            <tr>
                                ...
                                <td class="col-md-8"><input type="text" placeholder="title" class="form-control"
                                    name="news" value="<?php echo $row['title'];?>"></td>
                                </tr>
                                <tr>
