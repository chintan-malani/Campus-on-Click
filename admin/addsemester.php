...
<div class="content-section">
    <div class="container-liquid">
        <div class="row">
            <header>
                <h2 class="heading">Add Semester</h2>
            </header>
            <?php
    ...
    // FOREIGN KEY
            ...
            <div class="table-box">
                <table class="table">
                    <form action="semesterprocess.php" method="POST">
                        <tbody>
                            <tbody>
                             <tr>
                          ...
                          <tr>
                            <td class="col-md-4">Add Semester:</td>
                            <td class="col-md-8"><input type="text" placeholder="semester" class="form-control" name="semester"></td>
                        </tr>
