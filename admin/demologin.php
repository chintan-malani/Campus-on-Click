...
<div class="loginwrapper">
	...
	<div class="loginone">
        ...
        <form data-parsley-validate id="myform">
        	<div class="username">
        		<input type="text" class="form-control" placeholder="Enter your username"  name="" value="" class="form-control" required="" data-parsley-minlength="5"/>
                <i class="glyphicon glyphicon-user"></i>
            </div>
            <div class="password">
            	<input type="password" name="" value="" placeholder="Enter your username" class="form-control" required="" data-parsley-minlength="5" data-parsley-maxlength="9" data-parsley-minlength-message="Pls enter char between 5 to 12 to make it complex..!"/>
