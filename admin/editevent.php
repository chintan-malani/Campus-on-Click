...
$qry="SELECT * FROM event where event_id='".$_GET['id']."'";
            ...
            <div class="content-section">
                <div class="container-liquid">
                    <div class="row">
                        ...
                        <div class="table-box">
                                        <table class="table">
                                            <form action="updateeventprocess.php" method="POST">
                                            <tbody>
                                                <tr>
                                                    <td class="col-md-4">Add event name:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="event name" class="form-control" name="event" value="<?php echo $row['event_name'];?>"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">Add description</td>
                                                    <td class="col-md-8"><input type="text" placeholder="description" class="form-control" name="description" value="<?php echo $row['description'];?>"></td>
                                                </tr>
                                                <tr>
                                                    <td class="col-md-4">venue:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="venue" class="form-control" name="venue" value="<?php echo $row['place_of_event'];?>">
