...
$qry="SELECT * FROM security_question where sec_que_id='".$_GET['id']."'";
        ...
        <div class="right-sec">
            ...
            <div class="content-section">
                <div class="container-liquid">
                    <div class="row">
                        <header>
                                    <h2 class="heading">Add Security Question</h2>
                                </header>
                        <div class="table-box">
                                        <table class="table">
                                            <form action="updatequestionprocess.php" method="POST">
                                            <tbody>
                                                <tr>
                                                    <td class="col-md-4">Add Security questions:</td>
                                                    <td class="col-md-8"><input type="text" placeholder="Security questions" class="form-control" name="securityquestion" value="<?php echo $row['question'];?>">
