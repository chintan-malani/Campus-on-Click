        ...
        <div class="right-sec">
            ...
            <div class="content-section">
                <div class="container-liquid">
                    <div class="row">
                        <header>
                                    <h2 class="heading">Add Result</h2>
                                </header>
                        <div class="col-xs-12">
                            <div class="table-box">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                     <td class="col-md-4">Upload Result:</td>
                                                     <td class="col-md-8">
                                                         <input type="file" placeholder="description" class="form-control" name="file" required="">
                                                         <input type="hidden" name="sid" value="<?php echo $_GET['sid'];?>">
                                                     </td>
                                                </tr>
                                                    <td class="col-md-4">
                                                        <button class="btn btn-success" name="submit"> Upload Result</button></td>
                                                    <td class="col-md-8">
