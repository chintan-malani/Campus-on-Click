...
$qry="SELECT * FROM faculty where email='".$_POST['email']."' and isactive=1";
...
{
	echo "<script>alert('Invalid Email adderess');</script>";
...
<div class="loginwrapper">
    ...
    <div class="loginone">
        ...
        <form data-parsley-validate action="que.php" method="POST">
        	<div class="username">
            ...
            <br>
            <div class="username">
                <input type="text" class="form-control" placeholder="Enter your Answer"  name="answer" value="" class="form-control" required=""/>
