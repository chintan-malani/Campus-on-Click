...
<div class="loginwrapper">
    ...
    <div class="loginone">
        <header>
            <a><img src="assets/images/logo3.png" alt="abc"/></a>
        </header>
        <form data-parsley-validate action="loginprocess.php" method="POST">
            <div class="username">
                <input type="text" class="form-control" placeholder="Enter your Email"  name="txt_un" value="" class="form-control" required="" data-parsley-minlength="5"/>
                <i class="glyphicon glyphicon-user"></i>
            </div>
            <div class="password">
                <input type="password" name="txt_ps" value="" placeholder="Enter your password" class="fotxt_unrm-control" required="" data-parsley-minlength="5" data-parsley-maxlength="9" data-parsley-minlength-message="Pls enter char between 5 to 12 to make it complex..!"/>
        ...
        <footer>
            <a href="email.php" class="forgot pull-left">I forgot my password</a>
            <a href="register.php" class="register pull-right">Create account</a>
            <div class="clear"></div>
        </footer>
    </div>
</div>
