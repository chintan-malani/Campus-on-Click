...
$qry="SELECT * FROM faculty where email='".$_POST['email']."' and sec_que_id='".$_POST['que']."' and answer='".$_POST['answer']."'";
...
{
	echo "<script>alert('Wrong question and answer');</script>";
...
<div class="loginwrapper">
    ...
    <div class="loginone">
        ...
        <form data-parsley-validate action="reset.php" method="POST">
        	
            <br>
            <div class="username">
                <input type="text" class="form-control" placeholder="Enter your New Password"  name="pass" value="" class="form-control" required=""/>
                <input type="hidden" name="email" value="<?php echo $_POST['email'];?>">
                <!-- <i class="glyphicon glyphicon-user"></i> -->
            </div>
         	<div class="username">
                <input type="text" class="form-control" placeholder="Enter Confirm Password"  name="cpass" value="" class="form-control" required=""/>
                <input type="hidden" name="email" value="<?php echo $_POST['email'];?>">
                <!-- <i class="glyphicon glyphicon-user"></i> -->
            </div>
            ...
            <input type="submit" class="btn btn-primary style2" value="Reset" 
            name="btn_sb"/>
        </form>
