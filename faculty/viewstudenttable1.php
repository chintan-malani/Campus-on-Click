                                ...
                                <div class="contents">
                                    ...
                                    <section>
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php
                                                $qry="SELECT * FROM student where semester_id='".$_POST['semester']."'";
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="result.php?sid=<?php echo $row['stu_id'];?>"><button class="btn">Add</button></a></td>
                                                    <td><a href="viewresult.php?sid=<?php echo $row['stu_id'];?>"><button class="btn">View</button></a></td>
